...
export class MathHelpers {
  ...
  public static convertCoplanarPointsTo2D(a: number[][], planeAxis: { o: number[], n: number[], u: number[], v: number[] }): [number, number][] {
  ...
  public static checkIfPlanesAreCoincident(coplanarPoints1: number[][], coplanarPoints2: number[][]) {
...
public static compareBranches(backVector: Vector) {
    return function(a: {polygonId: number, edgeId: number, lineSegment: [number, number][]}, b: {polygonId: number, edgeId: number, lineSegment: [number, number][]}) {
        const branchAAngleToBack = MathHelpers.findCounterClockwiseAngleBetweenVectors(backVector, MathHelpers.findVectorBetweenPoints(a.lineSegment[0], a.lineSegment[1]) as [number, number]);
        const branchBAngleToBack = MathHelpers.findCounterClockwiseAngleBetweenVectors(backVector, MathHelpers.findVectorBetweenPoints(b.lineSegment[0], b.lineSegment[1]) as [number, number]);
